...
# Auth analysis scoring
HEURISTIC_AUTH_SPF_FAIL_SCORE = 0.30
HEURISTIC_AUTH_SPF_SOFTFAIL_SCORE = 0.15
HEURISTIC_AUTH_SPF_NEUTRAL_SCORE = 0.08
HEURISTIC_AUTH_SPF_ERROR_SCORE = 0.10
HEURISTIC_AUTH_DKIM_FAIL_SCORE = 0.25
HEURISTIC_AUTH_DKIM_ERROR_SCORE = 0.10
HEURISTIC_AUTH_DMARC_FAIL_SCORE = 0.45
HEURISTIC_AUTH_DMARC_NONE_SCORE = 0.15
